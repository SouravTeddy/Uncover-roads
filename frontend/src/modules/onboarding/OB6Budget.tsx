...
const OPTIONS = [
  { value: 'budget',      label: 'Budget',      sublabel: 'Free & cheap, always',
    imageUrl: 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=400&q=80' },
  { value: 'mid_range',   label: 'Mid-range',   sublabel: 'Selective splurges',
  ...
  { value: 'luxury',      label: 'Luxury',      sublabel: 'Best table in the room',
