  ...
  const executeBuild = useCallback(async () => {
    ...
    try {
      ...
      const res = await api.engineItinerary.start({
        ...
        engineWeights: null,
        rawOBAnswers: personaProfile ? {
          ritual:      personaProfile.ritual,
          sensory:     personaProfile.sensory,
          style:       personaProfile.style,
          attractions: personaProfile.attractions,
          pace:        personaProfile.pace,
          social:      personaProfile.social,
        } : null,
