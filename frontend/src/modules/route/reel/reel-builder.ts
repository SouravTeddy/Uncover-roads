      ...
      if (backendScenic && !scenicCard) {
        if (backendScenic.type === 'scenic') {
          ...
          cards.push({
            ...
            photoUrl:    null,
            originPhotoUrl: stop.imageUrl ?? (stop.photoRef ? getPlacePhotoUrl(stop.photoRef, 600) : null),
            destPhotoUrl: nextStop?.imageUrl ?? (nextStop?.photoRef ? getPlacePhotoUrl(nextStop.photoRef, 600) : null) ?? null,
